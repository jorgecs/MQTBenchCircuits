...
qc.h(q[5])
qc.x(q[6])
qc.cp(np.pi / 32, q[5], q[6])
qc.cx(q[5], q[4])
qc.cp(-np.pi / 32, q[4], q[6])
qc.cx(q[5], q[4])
qc.cp(np.pi / 32, q[4], q[6])
qc.cx(q[4], q[3])
qc.cp(-np.pi / 32, q[3], q[6])
qc.cx(q[5], q[3])
qc.cp(np.pi / 32, q[3], q[6])
qc.cx(q[4], q[3])
qc.cp(-np.pi / 32, q[3], q[6])
...
qc.cp(np.pi / 16, q[4], q[5])
qc.cx(q[4], q[3])
qc.cp(-np.pi / 16, q[3], q[5])
qc.cx(q[4], q[3])
qc.cp(np.pi / 16, q[3], q[5])
qc.cx(q[3], q[2])
qc.cp(-np.pi / 16, q[2], q[5])
qc.cx(q[4], q[2])
qc.cp(np.pi / 16, q[2], q[5])
qc.cx(q[3], q[2])
qc.cp(-np.pi / 16, q[2], q[5])
